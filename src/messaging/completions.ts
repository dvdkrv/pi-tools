...
const commands: readonly AutocompleteItem[] = [
  ...
  { value: 'send', label: 'send', description: 'Pick a peer and compose a queued notice or request' },
  { value: 'routes', label: 'routes', description: 'Inspect or explicitly open/close directional peer routes' },
